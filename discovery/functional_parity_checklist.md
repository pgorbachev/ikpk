...
- [ ] **Phone number** — `+7 (812) 646-54-50` **и** `+7 981 038-77-97` displayed in header, clickable `tel:` links _(изменено решением заказчика 2026-08-19, D12: показываем оба номера, а не один. В шапке оба видны шире 1440 px, в полосе 1181–1440 остаётся первый (на 1180 и уже в шапке номера не было и до этой работы); на всех ширинах оба остаются в подвале, в полосе CTA, в мобильном меню и на `/kontakty`. Пороги взяты от измерения, см. TD-43. Паритет с живым сайтом этот пункт больше не задаёт.)_
