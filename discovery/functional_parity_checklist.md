...
- [ ] **Phone number** — `+7 (812) 646-54-50` **и** `+7 981 038-77-97` displayed in header, clickable `tel:` links _(изменено решением заказчика 2026-08-19, D12: показываем оба номера, а не один. В шапке оба видны на экранах шире 1440 px — ниже прячутся вместе, «оба или ни одного»; на всех ширинах оба остаются в подвале, в полосе CTA, в мобильном меню и на `/kontakty`. Причина порога и его измерение — TD-41. Паритет с живым сайтом этот пункт больше не задаёт.)_
