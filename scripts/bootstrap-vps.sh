...
server {
  ...
  # к канону 247 правил из include выше, но они порождаются из
  ...
  # выражения, поэтому 247 правил include продолжают работать как раньше и это
  # правило у них ничего не отбирает.
  #
