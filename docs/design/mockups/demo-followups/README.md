...
- **Дефект `tokens.css` рискует уехать вместе с непринятой веткой.** Записанного хватает,
  чтобы завести red/green, но живёт оно абзацем в README мокапов. Нужен отдельный адрес —
  запись в `docs/tech-debt.md` или issue, независимо от судьбы этих мокапов.
