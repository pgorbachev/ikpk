...
\* Database type inferred indirectly from Express API patterns and the typical
Next.js stack. No direct confirmation (API is behind authentication).
Requires verification once server access is obtained.
