...
владельца, а не пауза.** Записи, которые автоматический выход не разрешает (нет
...
- **Серверный контроль по отпечатку «занимает» состав данных — но не дольше 14 суток
  ...
  автоматического выхода нет, **и ручного тоже нет**: единственный выход — верхняя граница
