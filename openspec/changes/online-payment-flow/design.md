...
отпечаток посчитан **другим** материалом — каждый легитимный повтор получит `409`
«данные изменились» (ложное утверждение) вместо продолжения, и это не срабатывает как
третий исход именно потому, что версия формально разрешается. Дальше это ведёт к
MAJOR-2/P3-A тем же путём, если статус записи не терминален.
