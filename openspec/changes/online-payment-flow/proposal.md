...
- **не входит:** интеграция с API **замещаемого сайта** — это отдельная задача, её
  инвентаризация ведётся в `docs/legacy-api-inventory.md` (TD-34). Разговор с заказчиком
  19.08.2026 относится к ней, а не к стенду;
