...
суррогатом. **Первая из четырёх закрыта решением владельца 2026-08-12; открытыми
остаются точки 2–4.** Нумерация сохранена: на «Ограничение объёма №2/№3/№4» ссылаются
`design.md`, `tasks.md` и спека, и сдвиг номеров сделал бы эти ссылки ложными.
...
(external)` на конкретной из точек **2–3** (точка 1 закрыта решением владельца
