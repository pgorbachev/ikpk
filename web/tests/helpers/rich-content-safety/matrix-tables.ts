...
export const CONSTRAINED_VALUE_CASES: HtmlCase[] = [
  ...
  { id: 'datetime-yearless-dashed', html: '<time datetime="--11-18">x</time>', accept: true },
  { id: 'datetime-offset-negative-zero', html: '<time datetime="-00:00">x</time>', accept: false },
  { id: 'datetime-offset-plus-zero', html: '<time datetime="+00:00">x</time>', accept: true },
  { id: 'datetime-offset-plus-zero-basic', html: '<time datetime="+0000">x</time>', accept: true },
  ...
  { id: 'bool-disabled-true', html: '<input type="checkbox" disabled="true">', accept: false },
