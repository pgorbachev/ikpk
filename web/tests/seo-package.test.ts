...
describe('404 and sitemap', () => {
  ...
  it('404.html is lighter than 34KB (демо-баннер учитывается отдельно)', () => {
    ...
    // 25.08.2026, social-accounts: Telegram как марка + обе темы Rutube в DOM.
    // Замерено на `868b639`: боевая 404 — 33491 Б при прежнем лимите 32768 (+723).
    // Подъём назван (TD-41); запас над фактом ~1.3 КБ (34×1024−33491).
    const limit = isDemoBuild ? 35 * 1024 : 34 * 1024;
