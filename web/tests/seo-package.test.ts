...
describe('404 and sitemap', () => {
  ...
  it('404.html is lighter than 32KB (демо-баннер учитывается отдельно)', () => {
    ...
    // 24.08.2026, social-accounts: инлайн официальных марок в подвале. Замерено
    // на этой голове: боевая 404 — 31759 Б при прежнем лимите 28672 (+3087).
    // Запас над фактом того же порядка, что в прошлый подъём (~1 КБ).
    const limit = isDemoBuild ? 33 * 1024 : 32 * 1024;
