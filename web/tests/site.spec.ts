...
// целиком, иначе комментарий вводит в заблуждение: зона 901–1172 переполняется
// и на main, и на этой ветке, причём ветка ХУЖЕ — 272/173/73 CSS-px при
// 901/1000/1100 против 209/110/10 у main (длиннее подпись CTA). Заведено как
// TD-40; исправление меняет раскладку шапки и идёт через мокап.
//
