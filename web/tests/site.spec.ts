...
//
// Предмет — «у посетителя есть чем перейти на другую страницу»: видно либо
// горизонтальное меню, либо кнопку бургера. Какое из двух — не важно, важно
// что хоть что-то. Переполнение по горизонтали здесь НЕ проверяется: в зоне
// 901–1180 оно существует и на main (замерено: 209/160/110/10 CSS-px при
// 901/950/1000/1100), заведено как TD-40 и этой работой не вносится.
const NAV_WIDTHS = [375, 430, 431, 600, 768, 900, 901, 1100, 1280];
