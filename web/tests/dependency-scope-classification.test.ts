...
//
// Замерено: main красный с 16.09.2026 ровно из-за такого расхождения — вершина `36b58cec`
// («bump tsx in /scripts») трогает только package.json/package-lock.json, скрипт считает
