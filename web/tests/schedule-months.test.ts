...
//
// Существующий гейт `schedule-window.test.ts:62-98` ловит своё: сравнение
// `startAt` с датой. Он НЕ ловит ни сборку объекта даты для подписи, ни
// `slice(0, 10)`, вынесенный в переменную, — поэтому проверки ниже нужны отдельно.
